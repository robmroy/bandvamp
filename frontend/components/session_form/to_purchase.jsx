...
function toPurchase({openModal, push, closeModal, demo}) {
  
  return (
    <div className = 'modal-form to-follow-modal ta-center' >
        To buy this album please 
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(toPurchase));
